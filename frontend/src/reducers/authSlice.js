...
export const register = createAsyncThunk('/register', async({formValue,navigate, toast}, {rejectWithValue}) => {
    try {
        ...
        const response = await axios.post(`${process.env.REACT_APP_SEREVR_DOMAIN}/users/register`, formValue)
...
export const login = createAsyncThunk('/login', async({formValue,navigate, toast}, {rejectWithValue}) => {
    try {
        ...
        const response = await axios.post(`${process.env.REACT_APP_SEREVR_DOMAIN}/users/login`, formValue)
...
export const logOut = createAsyncThunk('logout', async ({navigate, toast}) => {
    try {
        await axios.get(`${process.env.REACT_APP_SEREVR_DOMAIN}/users/logout`)
        localStorage.clear()
