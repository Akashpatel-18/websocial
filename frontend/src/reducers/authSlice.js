...
export const register = createAsyncThunk('/register', async({formValue,navigate, toast}, {rejectWithValue}) => {
    try {
        ...
        const response = await axios.post(`https://websocial-backend.onrender.com/users/register`, formValue)
...
export const login = createAsyncThunk('/login', async({formValue,navigate, toast}, {rejectWithValue}) => {
    try {
        ...
        const response = await axios.post(`https://websocial-backend.onrender.com/users/login`, formValue)
...
export const logOut = createAsyncThunk('logout', async ({navigate, toast}) => {
    try {
        await axios.get(`https://websocial-backend.onrender.com/users/logout`)
        localStorage.clear()
